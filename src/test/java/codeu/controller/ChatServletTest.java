...
@Test
  ...
  @Test
  public void testDoPost_ConvertingEmoji_Duplicate() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
  ...
  @Test
  public void testDoPost_MissingBoldEnd() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
  ...
  @Test
  public void testDoPost_MissingItalEnd() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("<i> <i> &#x1F629; &#x1F629; &#x1F629; blegh</i></i>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_MissingUnderEnd() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("<u> <b> <u> &#x1F629; &#x1F629; &#x1F629; blegh</b></u></u>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_MissingBoldEndFront() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("</b> <u> <b> <u> &#x1F629; &#x1F629; &#x1F629; blegh</b></u></u>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_MissingBoldEndMiddle() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("</b> <u> <b> </b> </b> <b> <u> &#x1F629; &#x1F629; &#x1F629; blegh</b></u></u>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_MissingAlternatingTag() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("</b> <u> <i> </i> <i> </i> </b> </b> <u> &#x1F629; &#x1F629; &#x1F629; blegh</u></u>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_TaggingOtherUserExists() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("Hi <a href='/user/test_otherusername'>@test_otherusername</a>",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_TaggingOtherUserDoesntExist() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("Hi @test_otherusername",
        messageArgumentCaptor.getValue().getContent());
  ...
  @Test
  public void testDoPost_TaggingYourself() throws IOException, ServletException {
    Mockito.when(mockRequest.getRequestURI()).thenReturn("/chat/test_conversation");
    Mockito.when(mockSession.getAttribute("user")).thenReturn("test_username");
    ...
    ArgumentCaptor<Message> messageArgumentCaptor = ArgumentCaptor.forClass(Message.class);
    Mockito.verify(mockMessageStore).addMessage(messageArgumentCaptor.capture());
    Assert.assertEquals("Hi @test_username",
        messageArgumentCaptor.getValue().getContent());
